...
if platform.system() == 'Windows':
    db_location = os.path.normpath('E:/Code/twitterDB.db') # e.g. 'C:/Twitter_Scraping_Project/twitterDB.db'
else:
...
def getSentiment(SentimentURL):
        ...
        if data is None:
            ...
            for t in tqdm(data.fetchall(),leave=1):
                id = t[0]
                payload['text'] = t[1]
                #concatenate if tweet is on multiple lines
